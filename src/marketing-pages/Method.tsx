...
const FeatureCard = ({ icon: Icon, title, desc }: { icon: any, title: string, desc: string }) => (
    <motion.div
        whileHover={{ y: -5 }}
        className="p-8 bg-stone-50 dark:bg-black/40 border border-stone-200 dark:border-white/5 rounded-xs space-y-4 hover:border-gold/30 transition-all group duration-300"
    >
        ...
        <div className="pt-32 pb-24 px-6 md:px-12 lg:px-24">
            ...
            <section className="max-w-6xl mx-auto mb-32 text-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl leading-tight text-stone-900 dark:text-white transition-colors duration-300">
                        See the Harmony. <br />
            ...
            <section className="max-w-6xl mx-auto mb-48">
                <div className="relative aspect-video rounded-xs overflow-hidden border border-stone-200 dark:border-white/10 bg-stone-100 dark:bg-charcoal shadow-2xl shadow-gold/5 transition-colors duration-300">
                    ...
                    <div className="absolute bottom-12 left-12 max-w-lg space-y-4">
                        <h2 className="text-3xl font-serif text-stone-900 dark:text-white transition-colors duration-300">Intuitive Harmonic Visualization</h2>
            ...
            <section className="max-w-4xl mx-auto text-center border-t border-stone-200 dark:border-white/5 pt-24 transition-colors duration-300">
                <h2 className="text-4xl md:text-5xl mb-8 leading-tight text-stone-900 dark:text-white transition-colors duration-300">The shortest path between <br /><span className="text-gold italic">thought and sound.</span></h2>
