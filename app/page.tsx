        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
            ...
            >
                <h1 className="text-5xl md:text-7xl lg:text-8xl mb-8 leading-[1.1] font-serif">
                    ...
                    <span className="italic text-gold-500">Speak the Language.</span>
                </h1>
            ...
            <div className="space-y-8">
                ...
                <div className="pt-12 border-t border-stone-100 dark:border-white/5">
                    <div className="flex flex-wrap gap-8 items-center opacity-30 grayscale pointer-events-none dark:invert-0 invert transition-all duration-300 font-serif">
                        ...
                        <span className="text-xl font-bold tracking-widest">GRAMMY</span>
                    </div>
                </div>
            </div>
        </section>
...
const VisualMethod = () => {
    return (
        <section className="py-32 px-6 md:px-12 bg-stone-50 dark:bg-[#050505] transition-colors duration-300">
            <div className="text-center mb-20 space-y-4">
                <h2 className="text-4xl md:text-6xl tracking-tight text-stone-900 dark:text-white transition-colors duration-300 font-serif">Music Theory, <span className="text-gold-500 italic">Visualized.</span></h2>
                <p className="text-stone-900/50 dark:text-alabaster/50 text-xl font-light max-w-2xl mx-auto transition-colors duration-300 font-sans">The Synesthesia Engine: See the harmony before you hear it.</p>
            </div>
            ...
            <motion.div
                ...
                className="max-w-6xl mx-auto p-4 bg-white dark:bg-charcoal border border-stone-200 dark:border-white/10 rounded-xs shadow-2xl shadow-gold-500/5 relative overflow-hidden transition-colors duration-300"
            >
                <div className="absolute inset-0 bg-gold-500/5 pointer-events-none blur-3xl rounded-full translate-y-1/2" />
                <div className="aspect-video w-full rounded-xs overflow-hidden border border-stone-100 dark:border-white/5 bg-stone-100 dark:bg-black/40 transition-colors duration-300 relative">
                    <Image
                        src="/assets/synesthesia.png"
                        alt="Synesthesia Engine Interface"
                        fill
...
const Journey = () => {
    ...
    return (
        <section className="py-32 px-6 md:px-12 bg-white dark:bg-charcoal transition-colors duration-300">
            <div className="max-w-5xl mx-auto relative px-4">
                <div className="absolute left-[39px] top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-gold-500/30 to-transparent hidden md:block" />
                ...
                <div className="space-y-24">
                    {steps.map((step, idx) => (
                        ...
                        >
                            <div className="w-20 h-20 rounded-full border border-gold-500/50 bg-white dark:bg-charcoal flex items-center justify-center text-gold-500 shadow-lg shadow-gold-500/10 shrink-0 transition-colors duration-300">
                                {step.icon}
                            </div>
                            <div className="space-y-2 pt-4">
                                <span className="text-gold-500/50 text-sm font-sans tracking-[0.3em] uppercase font-bold">STEP 0{idx + 1}</span>
                                <h3 className="text-3xl text-stone-900 dark:text-alabaster transition-colors duration-300 font-serif">{step.title}</h3>
...
const Pricing = () => {
    ...
    return (
        <section className="py-32 px-6 md:px-12 bg-stone-50 dark:bg-[#050505] transition-colors duration-300">
            <div className="text-center mb-20 space-y-4">
                <h2 className="text-4xl md:text-6xl tracking-tight text-stone-900 dark:text-white transition-colors duration-300 font-serif">The Patronage</h2>
                <p className="text-stone-900/50 dark:text-alabaster/50 text-xl font-light italic transition-colors duration-300 font-sans">Choose your level of mastery.</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
                {tiers.map((tier, idx) => (
                    <motion.div
                        key={idx}
                        whileHover={{ y: -10 }}
                        className={`p-10 border ${tier.gold ? 'border-gold-500 shadow-2xl shadow-gold-500/10' : 'border-stone-200 dark:border-white/10'} bg-white dark:bg-charcoal flex flex-col transition-all duration-300`}
                    >
